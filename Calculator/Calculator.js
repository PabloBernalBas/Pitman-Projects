...
const Calculator = {
    ...
    First_Operand: null,
    // this checks whether or not the second operand has
...
function Input_Decimal(dot) {
    ...
    //we are saying that it the Display value does not contain a decimal point 
...
function Handle_Operator (Next_Operator) {
    ...
    if (operator && Calculator.Wait__Second_Operand) {
